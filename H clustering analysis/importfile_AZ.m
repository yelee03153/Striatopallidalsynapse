function [scalebar_x,scalebar_y,synapticAreaOutline_x,synapticAreaOutline_y,smallGoldParticleCoordinates_x,smallGoldParticleCoordinates_y] = importfile_AZ(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [SCALEBAR_X,SCALEBAR_Y,SYNAPTICAREAOUTLINE_X,SYNAPTICAREAOUTLINE_Y,SMALLGOLDPARTICLECOORDINATES_X,SMALLGOLDPARTICLECOORDINATES_Y]
%   = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
% Example:
%   [scalebar_x,scalebar_y,synapticAreaOutline_x,synapticAreaOutline_y,smallGoldParticleCoordinates_x,smallGoldParticleCoordinates_y] = importfile('ml_10.gss',1, 29);
...
scalebar_x = rawCellColumns(:, 1);
scalebar_y = rawCellColumns(:, 2);
