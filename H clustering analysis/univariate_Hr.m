...
d = dir('C:\Users\USER\Downloads\Univariate_Analysis_JH\Univariate_Analysis_JH\Larger_Scale\DLS');
...
for i=1:ncols
   ...
   % figure, plot(x,y,'o')
    ...
    [H_data(i,:), H_upper(i,:), H_lower(i,:), H_rand_temp]=Hr_fun_sim([x ;y],are(i),dist,sims,xp,min_d,99);
    ...
    [h_pattern_di_h(i,:),pval_pattern_di_h(i,:)]=dclf_test(H_rand_temp,sims,H_data(i,:),95, dist);
...
[H_tot,pval_tot]=mad_test1(H_all,ncols*sims,H_ncols,99);
[H_dclf,pval_dclf]=dclf_test(H_all,ncols*sims,H_ncols,95,dist);
