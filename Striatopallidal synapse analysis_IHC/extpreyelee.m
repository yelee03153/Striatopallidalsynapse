...
function res_clustering_pre = extpreyelee(input_pre,input_body ,params)
...
%% Imfill
res_fill_body = imfill(res_open2, 'holes');
...
res_clustering_pre = res_label_pre;
% 
% figure, imagesc(res_label_pre), colormap colorcube
% title('labeling cluster')
