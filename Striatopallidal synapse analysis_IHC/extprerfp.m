...
function res_clustering_rfp = extprerfp(input_pre,params)
...
%% Denoising
res_denoising1 = imgaussfilt(input_pre,params.deno3);
...
res_idx1 = find(res_tophat1> params.hard_lev3);
...
res_bw11 = imbinarize(res_thres1, check_threshold1* params.otsu3);

% figure, imagesc(res_bw), colormap gray, title('thresholding')

res_bw22 = bwareaopen(res_bw11, params.deno_px_number3);
